  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto w-[393px] h-[852px] relative">
      <div className="flex-1 overflow-y-auto p-6 pb-40">
        ...
        <div
          className="w-full h-2 bg-gray-200 rounded-full overflow-hidden mt-[81px] mb-[81px]"
        >
          <div
      ...
      <div className="fixed bottom-0 left-0 right-0 px-4 pb-4 space-y-2 max-w-md mx-auto">
        ...
        {/* Tampilkan tombol Previous jika bukan Step 0 dan bukan Step 4 */}
        {currentStep !== 0 && currentStep !== 4 && (
          <button
            onClick={prev}
