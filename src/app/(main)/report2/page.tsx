...
const page = () => {
  return (
    <div style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '32px 0' }}>
      <h2 style={{ marginBottom: 24, fontWeight: 500 }}>AI Analysis Result</h2>
      <div style={{ background: '#F6FCF8', border: '1.5px solid #B6E2C6', borderRadius: 32, width: 340, display: 'flex', alignItems: 'center', padding: 20, marginBottom: 24 }}>
        <div style={{ width: 56, height: 56, borderRadius: '50%', border: '2px solid #B6E2C6', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, fontWeight: 600, color: '#4CB782', marginRight: 18 }}>A</div>
        <div>
          <div style={{ fontSize: 15, color: '#7A7A7A' }}>Your Plant Condition's</div>
          <div style={{ fontSize: 20, color: '#4CB782', fontWeight: 600 }}>Excellent</div>
        </div>
      </div>
      {/* Additional Notes */}
      <div style={{ width: 340, background: '#fff', borderRadius: 18, boxShadow: '0 2px 8px #0001', marginBottom: 18 }}>
        <div style={{ padding: '14px 20px', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
          <span style={{ fontWeight: 500 }}>Additional Notes</span>
          <span style={{ fontSize: 22, color: '#7A7A7A' }}>▼</span>
        </div>
        <div style={{ padding: '14px 20px', fontSize: 14, color: '#444' }}>
          <b>Plant Height:</b><br />
      ...
      {/* Recommended Actions */}
      <div style={{ width: 340, background: '#fff', borderRadius: 18, boxShadow: '0 2px 8px #0001', marginBottom: 32 }}>
        <div style={{ padding: '14px 20px', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
      ...
      <button style={{ width: 340, background: '#4CB782', color: '#fff', border: 'none', borderRadius: 12, padding: '16px 0', fontSize: 18, fontWeight: 600, boxShadow: '0 2px 8px #0001', cursor: 'pointer' }}>
        Save & Continue
      </button>
    </div>
  )
