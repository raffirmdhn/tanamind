...
const reportSchema = z.object({
  ...
  photo: z.any()
    ...
    .refine((files) => files?.[0]?.size <= 5_000_000, "Ukuran file maksimal 5MB.") // Optional: file size check
    .refine(
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              {form.formState.errors.photo && <p className="text-sm text-destructive">err</p>}
            </div>

            <Button 
              type="submit" 
              className="w-full" 
              disabled={!form.formState.isValid || loading || fetchingPlants}
            >
